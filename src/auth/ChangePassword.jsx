...
import AuthCaptcha from './auth-panel/AuthCaptcha.jsx'
      ...
      <AuthShell>
        <div className="auth-panel">
          <div className="auth-panel__notice">
            ...
            <p>Your password has been successfully updated. Redirecting to your dashboard...</p>
          </div>
        </div>
      </AuthShell>
    )
    ...
    <AuthShell>
      <div className="auth-panel">
        <div className="auth-panel__header">
          ...
          <p className="auth-panel__desc">Please set a new secure password for your reviewer account.</p>
        </div>
        ...
        <form className="auth-panel__form" onSubmit={handleSubmit}>
          ...
          <button className="auth-panel__cta" type="submit" disabled={loading || !captchaToken}>
