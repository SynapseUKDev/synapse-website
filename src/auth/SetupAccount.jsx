...
function SetupAccount() {
    ...
    const aside = {
        ...
        headline: <>Welcome to <span>EduSynapse</span></>,
        subtitle: invite ? invite.hero : 'Set up your account to get started.',
    }
                    ...
                    <div className="auth-panel__notice">
                        ...
                        <p>
                            {successGoesToLogin
                                ...
                                : "Welcome to EduSynapse! You're being redirected to your dashboard..."}
                        </p>
                    </div>
                </div>
            </AuthShell>
            ...
            <div className="auth-panel">
                <div className="auth-panel__header">
                    ...
                    <p className="auth-panel__desc">
                        You've been invited to EduSynapse. Set up your account to get started.
                    </p>
                </div>
                ...
                {invite && (
                    <div className="auth-panel__trial-banner">
                        ...
                        <div className="auth-panel__trial-content">
                            <div className="auth-panel__trial-title">{invite.title}</div>
                            <div className="auth-panel__trial-subtitle">{invite.subtitle}</div>
                        </div>
                    </div>
                )}
                ...
                <form className="auth-panel__form" onSubmit={handleSubmit}>
                    ...
                    <input className="auth-panel__input" type="email" value={email} disabled />
